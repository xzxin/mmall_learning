...
/** @ClassName: ProductManageController @Description: 商品管理后台 @Author @Date 2021/2/13 @Version 1.0 */
@Controller
...
public class ProductManageController {
  ...
  public ServerResponse productSave(HttpSession session, Product product) {
    ...
    if (user == null) {
      return ServerResponse.createByErrorCodeMessage(ResponseCode.NEED_LOGIN.getCode(), "请登录管理员用户");
    }
